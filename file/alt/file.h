...
#ifndef CPP_BASE_FILE_ALT_FILE_H_
#define CPP_BASE_FILE_ALT_FILE_H_
...
// As of 2014-06, these methods can only be used with flags = alt_file::Defaults().
bool SetContents(const std::string& filename, const std::string& contents,
                 int flags, std::string* error);
bool GetContents(const std::string& filename, std::string* output,
                 int flags, std::string* error);
bool WriteString(File* file, const std::string& contents,
                 int flags, std::string* error);
...
#endif  // CPP_BASE_FILE_ALT_FILE_H_
