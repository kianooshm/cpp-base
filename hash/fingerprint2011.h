...
#ifndef CPP_BASE_HASH_FINGERPRINT2011_H_
#define CPP_BASE_HASH_FINGERPRINT2011_H_
...
inline uint64 Fingerprint2011(const std::string& str) {
    return Fingerprint2011(str.c_str(), (size_t) str.length());
}

}  // namespace cpp_base

#endif  // CPP_BASE_HASH_FINGERPRINT2011_H_
