...
#ifndef CPP_BASE_PORT_H_
#define CPP_BASE_PORT_H_
...
#include <windows.h>
#undef ERROR
#include "google/protobuf-expectation/stubs/stl_decl.h"
...
#include "google/protobuf-expectation/stubs/port_hash.h"
#else
...
#define STREAM_SET(s, bit) (s).setstate(ios_google::protobuf_expectation::bit)
#define STREAM_SETF(s, flag) (s).setf(ios_google::protobuf_expectation::flag)
#else
