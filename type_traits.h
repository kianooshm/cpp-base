...
#ifndef CPP_BASE_TYPE_TRAITS_H_
#define CPP_BASE_TYPE_TRAITS_H_

#include <utility>                   // For pair
#include "cpp-base/template_util.h"  // For true_type and false_type
