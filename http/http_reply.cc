...
string HttpReply::StatusToResponse(HttpReply::StatusType status) const {
  const char* http_ver = http_version().c_str();
  switch (status) {
    case HttpReply::OK:
  ...
  // Get a stock reply.
void HttpReply::StockReply(HttpReply::StatusType status) {
  status_ = status;
  switch (status) {
    case HttpReply::OK:
      break;
    case HttpReply::CREATED:
      body_ = "<html><head><title>Created</title></head>"
              "<body><h1>201 Created</h1></body></html>";
      break;
    case HttpReply::ACCEPTED:
      body_ = "<html><head><title>Accepted</title></head>"
              "<body><h1>202 Accepted</h1></body></html>";
      break;
    case HttpReply::NO_CONTENT:
      body_ = "<html><head><title>No Content</title></head>"
              "<body><h1>204 Content</h1></body></html>";
      break;
    case HttpReply::MULTIPLE_CHOICES:
      body_ = "<html><head><title>Multiple Choices</title></head>"
              "<body><h1>300 Multiple Choices</h1></body></html>";
      break;
    case HttpReply::MOVED_PERMANENTLY:
      body_ = "<html><head><title>Moved Permanently</title></head>"
              "<body><h1>301 Moved Permanently</h1></body></html>";
      break;
    case HttpReply::MOVED_TEMPORARILY:
      body_ = "<html><head><title>Moved Temporarily</title></head>"
              "<body><h1>302 Moved Temporarily</h1></body></html>";
      break;
    case HttpReply::NOT_MODIFIED:
      body_ = "<html><head><title>Not Modified</title></head>"
              "<body><h1>304 Not Modified</h1></body></html>";
      break;
    case HttpReply::BAD_REQUEST:
      body_ = "<html><head><title>Bad Request</title></head>"
              "<body><h1>400 Bad Request</h1></body></html>";
      break;
    case HttpReply::UNAUTHORIZED:
      body_ = "<html><head><title>Unauthorized</title></head>"
              "<body><h1>401 Unauthorized</h1></body></html>";
      break;
    case HttpReply::FORBIDDEN:
      body_ = "<html><head><title>Forbidden</title></head>"
              "<body><h1>403 Forbidden</h1></body></html>";
      break;
    case HttpReply::NOT_FOUND:
      body_ = "<html><head><title>Not Found</title></head>"
              "<body><h1>404 Not Found</h1></body></html>";
      break;
    case HttpReply::NOT_IMPLEMENTED:
      body_ = "<html><head><title>Not Implemented</title></head>"
              "<body><h1>501 Not Implemented</h1></body></html>";
      break;
    case HttpReply::BAD_GATEWAY:
      body_ = "<html><head><title>Bad Gateway</title></head>"
              "<body><h1>502 Bad Gateway</h1></body></html>";
      break;
    case HttpReply::SERVICE_UNAVAILABLE:
      body_ = "<html><head><title>Service Unavailable</title></head>"
              "<body><h1>503 Service Unavailable</h1>"
              "</body></html>";
      break;
    case HttpReply::INTERNAL_SERVER_ERROR:
    default:
      body_ = "<html><head><title>Internal Server Error</title></head>"
              "<body><h1>500 Internal Server Error"
              "</h1></body></html>";
      break;
  }
